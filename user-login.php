        ...
        <div id="breadcrumb"> 
            <div class="container">
                <div class="le-breadcrumb inline"> 
                    <ul><li><a href="index.php" class="headerNavigation">Home</a></li><li><a href="user-login.php" class="headerNavigation">Login</a></li></ul> 
                </div>
            </div> 
        </div> 
  ...
  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 login">
	<div class="content">
        ...
        <div class="contentText">
        	<div class="information">I am a returning customer.</div>
    ...
    <div class="loginarea buttons-set">
        <div class="buttonRow forward login-buttons">
            <a class="forgot-password" href="password_forgotten.html">Forgot your password?</a>            <span class="tdbLink"><button id="user-login-btn" name="user-login-btn" type="submit">Sign In</button></span><script type="text/javascript">$("#tdb1").button({icons:{primary:"ui-icon-key"}}).addClass("ui-priority-primary").parent().removeClass("tdbLink");</script>        </div>
	</div>
    </form>
</div>
...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 create-account">
    ...
    <div class="buttons-set">
    	<div class="buttonRow forward create-account-button cart-buttons">
			<span class="tdbLink"><a id="tdb2" href="user-registration.php">Continue</a></span><script type="text/javascript">$("#tdb2").button({icons:{primary:"ui-icon-triangle-1-e"}}).addClass("ui-priority-secondary").parent().removeClass("tdbLink");</script>		</div>
    </div>
</div>
</div>
</div>
