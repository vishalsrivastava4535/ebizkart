            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 city">
                        ...
                        <option value="Afghanistan1">Afghanistan</option>
                        ...
                        <option value=" anAntiguad Barbuda"> anAntiguad Barbuda</option>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 telephone">
                        <h4>Your Contact Information</h4>
                  		<label class="inputLabel">
							Telephone Number:                        	<span class="inputRequirement alert-text">*</span>
						</label>
...
$stmt = $conn-> prepare("INSERT INTO user_info (`first_name`,`last_name`,`gender`,`d_o_b`,`email`,`street_address`,`pin_code`,`city`,`state`,`country`,`contact_no`,`user_password`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
...
window.location = 'http://localhost/magnusnew/user-login.php';
</script>";
